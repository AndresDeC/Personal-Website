    ...
    <div className="min-h-screen bg-[#020617] text-slate-100 font-sans selection:bg-blue-500/30 overflow-x-hidden">
      ...
      <nav className="p-8 flex justify-between items-center max-w-6xl mx-auto backdrop-blur-sm sticky top-0 z-50">
        ...
        <div className="flex items-center gap-8 text-[10px] font-bold text-slate-400 uppercase tracking-[0.3em]">
          <a href="#proyectos" className="hover:text-white transition-colors hidden md:block">Portafolio</a>
          <a href="#trayectoria" className="hover:text-white transition-colors hidden md:block">Trayectoria</a>
          {/* BOTÓN DESCARGA CV */}
          <a 
            href="/CV_Andres_Deandar.pdf" 
            download="CV_Andres_Deandar.pdf"
            className="px-5 py-2.5 bg-blue-600 hover:bg-blue-500 text-white rounded-full transition-all flex items-center gap-2 shadow-[0_0_20px_rgba(37,99,235,0.3)]"
          >
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <div className="space-y-4">
            ...
            <div className="border-l-2 border-blue-500/30 pl-6 py-2 text-white">
              <h4 className="text-lg font-bold leading-tight">Technical Web Consultant</h4>
              <p className="text-slate-500 text-[10px] mb-2 uppercase font-bold tracking-tighter italic">Freelance</p>
              <p className="text-slate-400 text-sm leading-relaxed">
                Optimización web mediante automatización de blogs. Gestión de proyectos internos e implementación de <span className="text-white">internacionalización (i18n)</span> con módulos de traducción dinámica.
              </p>
            </div>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="border-l-2 border-indigo-500/30 pl-6 py-2 text-white">
              <h4 className="text-lg font-bold leading-tight">Seleccionado de Basketball</h4>
              <p className="text-slate-500 text-[10px] mb-2 uppercase font-bold tracking-tighter italic">Estatales Edomex</p>
              <p className="text-slate-400 text-sm leading-relaxed">
                Cuartofinalista estatal. Formación de <span className="text-white">alto rendimiento</span> y resiliencia. Ejecución de estrategias tácticas en equipo bajo presión competitiva.
              </p>
            </div>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="border-l-2 border-slate-700 pl-6 py-2 text-white">
              <h4 className="text-lg font-bold leading-tight">Misionero Católico</h4>
              <p className="text-slate-500 text-[10px] mb-2 uppercase font-bold tracking-tighter italic">4 Ciclos · Trabajo en Equipo</p>
              <p className="text-slate-400 text-sm leading-relaxed">
                Acompañamiento y provisión de <span className="text-white">servicios espirituales</span> en comunidades rurales de México. Labor coordinada en equipo para evangelización y apoyo social.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-8 text-white">
          ...
          <div className="group p-8 border border-slate-800 rounded-[32px] bg-slate-900/20 hover:border-blue-500/40 transition-all duration-500 flex flex-col justify-between">
            <div>
              ...
              <p className="text-slate-400 text-lg leading-relaxed mb-8">
                Motor de conversión que reduce el tiempo de desarrollo en un <span className="text-white font-bold">60%</span>. Enfocado en la automatización de flujos editoriales.
              </p>
            </div>
            <div className="flex flex-wrap gap-2">
      ...
      <footer className="max-w-6xl mx-auto px-6 py-20 border-t border-slate-900 flex flex-col md:flex-row justify-between items-center gap-6 text-white text-center md:text-left">
        ...
        <a 
          ...
          className="text-slate-400 hover:text-blue-400 text-xs font-bold uppercase tracking-widest transition-colors border-b border-slate-800 pb-1"
        >
          Trabajemos juntos →
        </a>
      </footer>
