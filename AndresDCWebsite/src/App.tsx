...
const App: React.FC = () => {
  return (
    <div className="min-h-screen bg-[#020617] text-slate-100 font-sans selection:bg-blue-500/30 overflow-x-hidden">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div className="space-y-4">
            ...
            <div className="border-l-2 border-indigo-500/30 pl-6 py-2 text-white">
              ...
              <p className="text-slate-400 text-sm leading-relaxed">
                Cuartofinalista estatal. Formación de <span className="text-white">alto rendimiento</span> y resiliencia. Experiencia ejecutando estrategias tácticas en equipo bajo presión competitiva.
              </p>
            </div>
          </div>
      ...
      {/* --- SECCIÓN PROYECTOS (Actualizado con Tech Stack correcto) --- */}
          ...
          <div className="group p-8 border border-slate-800 rounded-[32px] bg-slate-900/20 hover:border-blue-500/40 transition-all duration-500 flex flex-col justify-between">
            <div>
              <div className="flex justify-between items-start mb-6">
                <h3 className="text-3xl font-bold group-hover:text-blue-400 transition-colors tracking-tight text-white">World Cup Planner</h3>
