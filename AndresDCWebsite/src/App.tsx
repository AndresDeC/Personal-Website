    ...
    <div className="min-h-screen bg-[#020617] text-slate-100 font-sans selection:bg-blue-500/30 overflow-x-hidden">
      ...
      <header className="max-w-4xl mx-auto pt-24 pb-20 px-6">
        ...
        <h1 className="text-6xl md:text-8xl font-black tracking-tighter mb-8 leading-tight">
          Sistemas con <br />
          <span className="bg-gradient-to-r from-blue-400 via-blue-600 to-indigo-400 bg-clip-text text-transparent">Propósito Humano.</span>
        </h1>
      ...
      {/* --- NUEVA SECCIÓN: TRAYECTORIA Y LIDERAZGO --- */}
        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div className="space-y-4">
            ...
            <div className="border-l-2 border-blue-500/30 pl-6 py-2">
              <h4 className="text-lg font-bold text-white leading-tight">Technical Web Consultant</h4>
              <p className="text-slate-500 text-[10px] mb-2 uppercase font-bold tracking-tighter">Freelance</p>
              <p className="text-slate-400 text-sm leading-relaxed">
                Optimización de plataforma web mediante la automatización de blogs. Implementación de módulos de <span className="text-white">internacionalización (i18n)</span> con botones de traducción dinámica.
              </p>
            </div>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="border-l-2 border-indigo-500/30 pl-6 py-2">
              <h4 className="text-lg font-bold text-white leading-tight">Seleccionado de Basketball</h4>
              <p className="text-slate-500 text-[10px] mb-2 uppercase font-bold tracking-tighter">Estatales Edomex</p>
              <p className="text-slate-400 text-sm leading-relaxed">
                Cuartofinalista estatal. Desarrollo de <span className="text-white">alto rendimiento</span>, resiliencia y trabajo en equipo bajo presión competitiva extrema.
              </p>
            </div>
          </div>
          ...
          {/* Misiones */}
          <div className="space-y-4">
            <h3 className="text-slate-500 font-bold uppercase tracking-widest text-[10px]">Impacto Social</h3>
            <div className="border-l-2 border-slate-700 pl-6 py-2">
              <h4 className="text-lg font-bold text-white leading-tight">Liderazgo en Misiones</h4>
              <p className="text-slate-500 text-[10px] mb-2 uppercase font-bold tracking-tighter">4 Experiencias en Terreno</p>
              <p className="text-slate-400 text-sm leading-relaxed">
                Gestión de proyectos en comunidad y resolución de problemas en entornos vulnerables. Fuerte enfoque en <span className="text-white">empatía y comunicación</span>.
              </p>
            </div>
          </div>
        </div>
      ...
      {/* --- SECCIÓN PROYECTOS (Manteniendo tus originales) --- */}
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <div className="group p-8 border border-slate-800 rounded-[32px] bg-slate-900/20 hover:border-blue-500/40 transition-all duration-500 flex flex-col justify-between">
            ...
            <div className="flex flex-wrap gap-2">
              {["React", "API Integration", "Google Auth"].map(tag => (
          ...
          <div className="group p-8 border border-slate-800 rounded-[32px] bg-slate-900/20 hover:border-blue-500/40 transition-all duration-500 flex flex-col justify-between">
            <div>
              <div className="flex justify-between items-start mb-6">
                ...
                <a href="https://velox-clothing.netlify.app/" target="_blank" rel="noreferrer" className="bg-white/5 p-3 rounded-full hover:bg-blue-500 transition-all text-white">
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14" /></svg>
                </a>
              </div>
              <p className="text-slate-400 text-lg leading-relaxed mb-8">
      ...
      <footer className="max-w-6xl mx-auto px-6 py-20 border-t border-slate-900 flex flex-col md:flex-row justify-between items-center gap-6 text-white">
        ...
        <p className="text-slate-600 text-[10px] italic">"Ingeniería impulsada por la disciplina y la empatía."</p>
      </footer>
    </div>
  );
};
